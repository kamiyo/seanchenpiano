...
<head>
	...
	<meta property="og:image" content="http://seanchenpiano.com/images/gallery/thumbs/cliburn7.jpg" />
...
<body class="flexbox" ng-cloak ng-app="root" ng-controller="rootCtrl">
	<div id="header">
		...
		<div id="menu">
			...
			<ul id="mainMenu" ng-controller="navigation">
				<li class="nav" click-nav="{{nav}}" ng-repeat="nav in navs"><a no-bubble class="nothing" ng-href="{{nav}}" ng-bind="nav"></a></li>
				<li class="spacer"></li>
			</ul>
		</div>
	</div>
	...
	<div id="front" class="over animate-show" fade-front>
		...
		<img id="theFront" class="animate-hide" ng-src="{{front}}" />
	</div>
	<div id="main">
	...
	<div ng-cloak id="mainFooter" class="animate-hide hide" ng-controller="mainFooter">
		...
		<script src="./scripts/plugins.<?php echo time(); ?>.js"></script>
